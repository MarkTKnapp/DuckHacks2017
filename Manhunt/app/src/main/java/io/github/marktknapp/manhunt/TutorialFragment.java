...
public class TutorialFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        TextView txt = (TextView)view.findViewById(R.id.tutorialText);
        txt.setText(getArguments().getString("TEXT"));
        Button btn = (Button)view.findViewById(R.id.dash_butt);
        if(getArguments().getInt("SHOW DASH_BUTT") == View.VISIBLE)
            btn.setVisibility(View.VISIBLE);
        else
            btn.setVisibility(View.INVISIBLE);

        view.findViewById(R.id.dash_butt).setOnTouchListener(new View.OnTouchListener() {
            @Override
